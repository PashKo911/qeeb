(() => {
    ...
    (() => {
        ...
        function initSliders() {
            ...
            if (document.querySelector(".tranding__slider")) new swiper_core_Swiper(".tranding__slider", {
                modules: [ Navigation, Pagination ],
                observer: true,
                observeParents: true,
                spaceBetween: 15,
        ...
        class CircleText {
            ...
            getPath() {
                ...
                return "M " + cxy + " " + cxy + " m -" + radius + ", 0 a " + radius + "," + radius + " 0 1,1 " + radius * 2 + ",0 a " + radius + "," + radius + " 0 1,1 -" + radius * 2 + ",0";
            }
            createSvg() {
